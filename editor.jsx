  ...
  <h3>Select Location:</h3>
    <div className="block">
        <select name="location">
          ...
          <option value="Cattle Creek above Coulter Creek">Cattle Creek above Coultier Creek</option>
          <option value="Cattle Creek below Coulter Creek">Cattle Creek below Coultier Creek</option>
   ...
   <div>
   <p> 
     <b>Note </b>Use the values already provided unless your sample location and your current location differ. In this case, use the GPS coordinates you noted from your sample location.</p>
            <p>If the are <b>Lat</b> and <b>Lon</b> fields are blank, please enter your gps position or allow your web browser to access your location and then re-load this page.</p>
